...
Thermometers.prototype.add_thermometers = function() {
  ...
  //Customisations
  self.svg.attr("class", "doodl_chart thermometers");
...
function thermometers(data, div, size) {
  ...
  var draw = function(processed_data, div, size) {
    ...
    var doodl_chart = new Thermometers(processed_data, div, size, ["category", "value"], scales);

    doodl_chart.add_svg().add_grid().add_thermometers();
